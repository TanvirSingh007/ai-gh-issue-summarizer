...
3. Whether the ticket was accepted and fixed, or closed and returned to CS.
...
def main():
    ...
    parser.add_argument('--batch', type=int, default=BATCH_SIZE, help='Number of issues to process in this batch')
